...
// District: Nagpur - FULL RANGE 2019-2026
// ============================================
...
var studyArea = districts
  ...
  .filter(ee.Filter.eq('ADM2_NAME', 'Nagpur'));

Map.centerObject(studyArea, 8);
Map.addLayer(studyArea, {color: 'red'}, 'Nagpur District Boundary');
...
Export.table.toDrive({
  ...
  description: 'nagpur_monthly_features_2019_2026',
  fileFormat: 'CSV'
});
