...
// District: Pune (Baramati) - FULL RANGE 2019-2026
// ============================================
...
Map.addLayer(studyArea, {color: 'red'}, 'Pune District Boundary');
...
Export.table.toDrive({
  ...
  description: 'pune_baramati_monthly_features_2019_2026_v2',
  fileFormat: 'CSV'
});
